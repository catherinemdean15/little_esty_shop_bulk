...
RSpec.describe InvoiceItem, type: :model do
  ...
  describe 'instance methods' do
    ...
    it "discount_applied" do
      ...
      expect(@ii_1.discount_applied.id).to eq(@bulk2.id)
      expect(@ii_1.discount_applied.threshold).to eq(@bulk2.threshold)
      expect(@ii_1.discount_applied.percent_discount).to eq(@bulk2.percent_discount)
    end
